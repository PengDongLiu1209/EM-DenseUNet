...
def main(args):
    ...
    train_path = f'/public/home/liupengdong2024/datastes/dataset_one/{dataset_name}/train'
    val_path = f'/public/home/liupengdong2024/datastes/dataset_one/{dataset_name}/val'
    test_path = f'/public/home/liupengdong2024/datastes/dataset_one/{dataset_name}/test'
    num_classes = 2
    print(f"[num_classes] {num_classes}")

    trainDataset = MyDataset_StrawDI_Db1(imgs_path=train_path,  transform=train_tf)
    valDataset   = MyDataset_StrawDI_Db1(imgs_path=val_path,    transform=val_tf)
    testDataset  = MyDataset_StrawDI_Db1(imgs_path=test_path,   transform=test_tf)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', default='StrawDI_Db1', type=str)
